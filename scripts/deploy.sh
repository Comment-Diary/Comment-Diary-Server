...
nohup java -jar \
    -Dspring.config.location=classpath:/application.yml,/home/ec2-user/app/deploy/resources/application-prod.yml $DEPLOY_JAR >> /home/ec2-user/deploy.log 2>/home/ec2-user/app/deploy/deploy_err.log &